...
class StudentDa:
    ...
    def save(self, student):
        self.connect()
        self.cursor.execute(
            "insert into student_tbl (name, family, national_id, birthday, phone_number, grade) values (%s,%s,%s,%s,%s,%s)",
    ...
    def edit(self, student):
        ...
        self.cursor.execute("update student_tbl set    where id=%s",
                            [student.name, student.family, student.national_id, student.birthday, student.phone_number,
